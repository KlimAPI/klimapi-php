...
/**
 * FuelsSolidFuelsWeight Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class FuelsSolidFuelsWeight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FuelsSolidFuelsWeight';
    ...
    public const SPECIFICATION_COAL_INDUSTRIAL = 'coal_industrial';
    public const SPECIFICATION_COAL_ELECTRICITY_GENERATION = 'coal_electricity_generation';
    public const SPECIFICATION_COAL_DOMESTIC = 'coal_domestic';
    public const SPECIFICATION_COKING_COAL = 'coking_coal';
    public const SPECIFICATION_PETROLEUM_COKE = 'petroleum_coke';
    public const SPECIFICATION_COAL_ELECTRICITY_GENERATION_HOME_PRODUCED_COAL_ONLY = 'coal_electricity_generation-home_produced_coal_only';
    ...
    {
        return [
            self::SPECIFICATION_COAL_INDUSTRIAL,
            self::SPECIFICATION_COAL_ELECTRICITY_GENERATION,
            self::SPECIFICATION_COAL_DOMESTIC,
            self::SPECIFICATION_COKING_COAL,
            self::SPECIFICATION_PETROLEUM_COKE,
            self::SPECIFICATION_COAL_ELECTRICITY_GENERATION_HOME_PRODUCED_COAL_ONLY,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('activity', $data ?? [], 'solid_fuels');
