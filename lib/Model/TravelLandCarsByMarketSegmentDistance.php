...
/**
 * TravelLandCarsByMarketSegmentDistance Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class TravelLandCarsByMarketSegmentDistance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TravelLandCarsByMarketSegmentDistance';
    ...
    public const SPECIFICATION_MINI = 'mini';
    public const SPECIFICATION_SUPERMINI = 'supermini';
    public const SPECIFICATION_LOWER_MEDIUM = 'lower_medium';
    public const SPECIFICATION_UPPER_MEDIUM = 'upper_medium';
    public const SPECIFICATION_EXECUTIVE = 'executive';
    public const SPECIFICATION_LUXURY = 'luxury';
    public const SPECIFICATION_SPORTS = 'sports';
    public const SPECIFICATION_DUAL_PURPOSE_4X4 = 'dual_purpose_4x4';
    public const SPECIFICATION_MPV = 'mpv';
    public const SPECIFICATION_AVERAGE = 'average';
    public const DETAIL_DIESEL = 'diesel';
    public const DETAIL_PETROL = 'petrol';
    public const DETAIL_BATTERY_ELECTRIC_VEHICLE = 'battery_electric_vehicle';
    public const DETAIL_AVERAGE = 'average';
    public const DETAIL_PLUG_IN_HYBRID_ELECTRIC_VEHICLE = 'plug-in_hybrid_electric_vehicle';
    ...
    {
        return [
            self::SPECIFICATION_MINI,
            self::SPECIFICATION_SUPERMINI,
            self::SPECIFICATION_LOWER_MEDIUM,
            self::SPECIFICATION_UPPER_MEDIUM,
            self::SPECIFICATION_EXECUTIVE,
            self::SPECIFICATION_LUXURY,
            self::SPECIFICATION_SPORTS,
            self::SPECIFICATION_DUAL_PURPOSE_4X4,
            self::SPECIFICATION_MPV,
    ...
    public function getDetailAllowableValues()
    {
        return [
            self::DETAIL_DIESEL,
            self::DETAIL_PETROL,
            self::DETAIL_BATTERY_ELECTRIC_VEHICLE,
            self::DETAIL_AVERAGE,
            self::DETAIL_PLUG_IN_HYBRID_ELECTRIC_VEHICLE,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('activity', $data ?? [], 'cars_by_market_segment');
        $this->setIfExists('specification', $data ?? [], 'average');
        $this->setIfExists('detail', $data ?? [], 'average');
        $this->setIfExists('value', $data ?? [], null);
        $this->setIfExists('unit', $data ?? [], 'kilometers');
    }
    ...
    */
     ...
     * Sets unit
     *
     * @param string|null $unit Need a more specific unit? See the **[full list of supported units (Section 6)](https://convert.js.org/types/_unitsbymeasureraw)**.
     *
     * @return self
     */
