...
/**
 * CloudComputingStorageTbHour Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class CloudComputingStorageTbHour implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CloudComputingStorageTbHour';
    ...
    public const UNIT_TB_HOUR = 'tb-hour';
