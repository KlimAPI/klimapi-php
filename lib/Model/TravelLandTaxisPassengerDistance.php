...
/**
 * TravelLandTaxisPassengerDistance Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class TravelLandTaxisPassengerDistance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TravelLandTaxisPassengerDistance';
    ...
    public const SPECIFICATION_BLACK_CAB = 'black_cab';
    public const SPECIFICATION_REGULAR_TAXI = 'regular_taxi';
    ...
    {
        return [
            self::SPECIFICATION_BLACK_CAB,
            self::SPECIFICATION_REGULAR_TAXI,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('activity', $data ?? [], 'taxis');
