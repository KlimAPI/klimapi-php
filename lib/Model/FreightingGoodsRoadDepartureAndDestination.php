...
/**
 * FreightingGoodsRoadDepartureAndDestination Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class FreightingGoodsRoadDepartureAndDestination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FreightingGoodsRoadDepartureAndDestination';
    ...
    public const SPECIFICATION_REFRIGERATED = 'refrigerated';
    ...
    {
        return [
            self::SPECIFICATION_REFRIGERATED,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('activity', $data ?? [], 'road');
