...
/**
 * TravelSeaFerryPassengerDistance Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class TravelSeaFerryPassengerDistance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TravelSeaFerryPassengerDistance';
    ...
    public const SPECIFICATION_FOOT_PASSENGER = 'foot_passenger';
    public const SPECIFICATION_CAR_PASSENGER = 'car_passenger';
    public const SPECIFICATION_AVERAGE_ALL_PASSENGER = 'average_all_passenger';
    ...
    {
        return [
            self::SPECIFICATION_FOOT_PASSENGER,
            self::SPECIFICATION_CAR_PASSENGER,
            self::SPECIFICATION_AVERAGE_ALL_PASSENGER,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('activity', $data ?? [], 'ferry');
