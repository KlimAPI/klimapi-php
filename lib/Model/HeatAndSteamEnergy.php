...
/**
 * HeatAndSteamEnergy Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class HeatAndSteamEnergy implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HeatAndSteamEnergy';
    ...
    public const ACTIVITY_ONSITE_HEAT_AND_STEAM = 'onsite_heat_and_steam';
    public const ACTIVITY_DISTRICT_HEAT_AND_STEAM = 'district_heat_and_steam';
    ...
    {
        return [
            self::ACTIVITY_ONSITE_HEAT_AND_STEAM,
            self::ACTIVITY_DISTRICT_HEAT_AND_STEAM,
