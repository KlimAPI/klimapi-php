...
/**
 * MaterialUsePaperWeight Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class MaterialUsePaperWeight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MaterialUsePaperWeight';
    ...
    public const SPECIFICATION_PAPER_AND_BOARDBOARD = 'paper_and_board:board';
    public const SPECIFICATION_PAPER_AND_BOARDMIXED = 'paper_and_board:mixed';
    public const SPECIFICATION_PAPER_AND_BOARDPAPER = 'paper_and_board:paper';
    ...
    {
        return [
            self::SPECIFICATION_PAPER_AND_BOARDBOARD,
            self::SPECIFICATION_PAPER_AND_BOARDMIXED,
            self::SPECIFICATION_PAPER_AND_BOARDPAPER,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('activity', $data ?? [], 'paper');
