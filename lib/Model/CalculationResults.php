...
/**
 * CalculationResults Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class CalculationResults implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CalculationResults';
    ...
    protected static $setters = [
        'kgCO2e' => 'setKgCO2e',
        'calculationId' => 'setCalculationId',
        'results' => 'setResults'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('calculationId', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['calculationId'];
    }

    /**
     * Sets calculationId
     *
     * @param string|null $calculationId The unique identifier of the calculation
     *
     * @return self
     */
    public function setCalculationId($calculationId)
    {
        if (is_null($calculationId)) {
            throw new \InvalidArgumentException('non-nullable calculationId cannot be null');
        }
        $this->container['calculationId'] = $calculationId;
     ...
     * Sets results
     *
     * @param \KlimAPI\Model\CalculationResult[]|null $results results
     *
     * @return self
     */
