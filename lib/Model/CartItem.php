...
class CartItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets amount
     *
     * @param int $amount The amount of the product in the cart
     *
     * @return self
     */
     ...
     * Sets total
     *
     * @param float $total The total price of the product in the cart
     *
     * @return self
     */
     ...
     * Sets product
     *
     * @param \KlimAPI\Model\Product $product product
     *
     * @return self
     */
