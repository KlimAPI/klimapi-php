...
/**
 * TravelLandMotorbikeDistance Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class TravelLandMotorbikeDistance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TravelLandMotorbikeDistance';
    ...
    public const SPECIFICATION_SMALL = 'small';
    public const SPECIFICATION_MEDIUM = 'medium';
    public const SPECIFICATION_LARGE = 'large';
    ...
    {
        return [
            self::SPECIFICATION_SMALL,
            self::SPECIFICATION_MEDIUM,
            self::SPECIFICATION_LARGE,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('activity', $data ?? [], 'motorbike');
