...
/**
 * BioenergyBiomassWeight Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class BioenergyBiomassWeight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BioenergyBiomassWeight';
    ...
    public const SPECIFICATION_WOOD_LOGS = 'wood_logs';
    public const SPECIFICATION_WOOD_CHIPS = 'wood_chips';
    public const SPECIFICATION_WOOD_PELLETS = 'wood_pellets';
    public const SPECIFICATION_GRASS_STRAW = 'grass/straw';
    ...
    {
        return [
            self::SPECIFICATION_WOOD_LOGS,
            self::SPECIFICATION_WOOD_CHIPS,
            self::SPECIFICATION_WOOD_PELLETS,
            self::SPECIFICATION_GRASS_STRAW,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('activity', $data ?? [], 'biomass');
