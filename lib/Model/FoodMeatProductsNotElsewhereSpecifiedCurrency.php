...
/**
 * FoodMeatProductsNotElsewhereSpecifiedCurrency Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class FoodMeatProductsNotElsewhereSpecifiedCurrency implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FoodMeatProductsNotElsewhereSpecifiedCurrency';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('activity', $data ?? [], 'meat_products_not_elsewhere_specified');
