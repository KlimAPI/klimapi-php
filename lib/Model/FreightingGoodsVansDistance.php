...
/**
 * FreightingGoodsVansDistance Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class FreightingGoodsVansDistance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FreightingGoodsVansDistance';
    ...
    public const SPECIFICATION_CLASS_I_UP_TO_1_305_TONS = 'class_i_up_to_1.305_tons';
    public const SPECIFICATION_CLASS_II_1_305_TO_1_74_TONS = 'class_ii_1.305_to_1.74_tons';
    public const SPECIFICATION_CLASS_III_1_74_TO_3_5_TONS = 'class_iii_1.74_to_3.5_tons';
    public const SPECIFICATION_AVERAGE_UP_TO_3_5_TONS = 'average_up_to_3.5_tons';
    ...
    public const DETAIL_CNG = 'cng';
    public const DETAIL_LPG = 'lpg';
    ...
    {
        return [
            self::SPECIFICATION_CLASS_I_UP_TO_1_305_TONS,
            self::SPECIFICATION_CLASS_II_1_305_TO_1_74_TONS,
            self::SPECIFICATION_CLASS_III_1_74_TO_3_5_TONS,
            self::SPECIFICATION_AVERAGE_UP_TO_3_5_TONS,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('activity', $data ?? [], 'vans');
