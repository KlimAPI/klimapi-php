...
/**
 * FoodFoodProductsNotElsewhereSpecifiedCurrency Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class FoodFoodProductsNotElsewhereSpecifiedCurrency implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FoodFoodProductsNotElsewhereSpecifiedCurrency';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('activity', $data ?? [], 'food_products_not_elsewhere_specified');
