...
/**
 * WasteDisposalElectricalItemsWeight Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class WasteDisposalElectricalItemsWeight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WasteDisposalElectricalItemsWeight';
    ...
    public const SPECIFICATION_WEEE_FRIDGES_AND_FREEZERS = 'weee-fridges_and_freezers';
    public const SPECIFICATION_WEEE_LARGE = 'weee-large';
    public const SPECIFICATION_WEEE_MIXED = 'weee-mixed';
    public const SPECIFICATION_WEEE_SMALL = 'weee-small';
    public const SPECIFICATION_BATTERIES = 'batteries';
    ...
    {
        return [
            self::SPECIFICATION_WEEE_FRIDGES_AND_FREEZERS,
            self::SPECIFICATION_WEEE_LARGE,
            self::SPECIFICATION_WEEE_MIXED,
            self::SPECIFICATION_WEEE_SMALL,
            self::SPECIFICATION_BATTERIES,
