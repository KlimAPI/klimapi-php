...
/**
 * MaterialUseOtherWeight Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class MaterialUseOtherWeight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MaterialUseOtherWeight';
    ...
    public const SPECIFICATION_GLASS = 'glass';
    public const SPECIFICATION_CLOTHING = 'clothing';
    public const SPECIFICATION_FOOD_AND_DRINK = 'food_and_drink';
    ...
    {
        return [
            self::SPECIFICATION_GLASS,
            self::SPECIFICATION_CLOTHING,
            self::SPECIFICATION_FOOD_AND_DRINK,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('activity', $data ?? [], 'other');
