...
/**
 * MaterialUsePlasticWeight Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class MaterialUsePlasticWeight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MaterialUsePlasticWeight';
    ...
    public const SPECIFICATION_PLASTICSPET_INCL__FORMING = 'plastics:pet_incl._forming';
    public const SPECIFICATION_PLASTICSAVERAGE_PLASTICS = 'plastics:average_plastics';
    public const SPECIFICATION_PLASTICSAVERAGE_PLASTIC_FILM = 'plastics:average_plastic_film';
    public const SPECIFICATION_PLASTICSAVERAGE_PLASTIC_RIGID = 'plastics:average_plastic_rigid';
    public const SPECIFICATION_PLASTICSHDPE_INCL__FORMING = 'plastics:hdpe_incl._forming';
    public const SPECIFICATION_PLASTICSLDPE_AND_LLDPE_INCL__FORMING = 'plastics:ldpe_and_lldpe_incl._forming';
    public const SPECIFICATION_PLASTICSPP_INCL__FORMING = 'plastics:pp_incl._forming';
    public const SPECIFICATION_PLASTICSPS_INCL__FORMING = 'plastics:ps_incl._forming';
    public const SPECIFICATION_PLASTICSPVC_INCL__FORMING = 'plastics:pvc_incl._forming';
    public const SPECIFICATION_AVERAGE = 'average';
    public const DETAIL_CLOSED_LOOP_SOURCE = 'closed-loop_source';
    public const DETAIL_PRIMARY_MATERIAL_PRODUCTION = 'primary_material_production';
    ...
    {
        return [
            self::SPECIFICATION_PLASTICSPET_INCL__FORMING,
            self::SPECIFICATION_PLASTICSAVERAGE_PLASTICS,
            self::SPECIFICATION_PLASTICSAVERAGE_PLASTIC_FILM,
            self::SPECIFICATION_PLASTICSAVERAGE_PLASTIC_RIGID,
            self::SPECIFICATION_PLASTICSHDPE_INCL__FORMING,
            self::SPECIFICATION_PLASTICSLDPE_AND_LLDPE_INCL__FORMING,
            self::SPECIFICATION_PLASTICSPP_INCL__FORMING,
            self::SPECIFICATION_PLASTICSPS_INCL__FORMING,
            self::SPECIFICATION_PLASTICSPVC_INCL__FORMING,
    ...
    {
        return [
            self::DETAIL_CLOSED_LOOP_SOURCE,
            self::DETAIL_PRIMARY_MATERIAL_PRODUCTION,
            self::DETAIL_AVERAGE,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('activity', $data ?? [], 'plastic');
