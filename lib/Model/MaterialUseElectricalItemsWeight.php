...
/**
 * MaterialUseElectricalItemsWeight Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class MaterialUseElectricalItemsWeight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MaterialUseElectricalItemsWeight';
    ...
    public const SPECIFICATION_ELECTRICAL_ITEMS_FRIDGES_AND_FREEZERS = 'electrical_items-fridges_and_freezers';
    public const SPECIFICATION_ELECTRICAL_ITEMS_LARGE = 'electrical_items-large';
    public const SPECIFICATION_ELECTRICAL_ITEMS_IT = 'electrical_items-it';
    public const SPECIFICATION_ELECTRICAL_ITEMS_SMALL = 'electrical_items-small';
    public const SPECIFICATION_BATTERIES_ALKALINE = 'batteries-alkaline';
    public const SPECIFICATION_BATTERIES_LI_ION = 'batteries-li_ion';
    public const SPECIFICATION_BATTERIES_NIMH = 'batteries-nimh';
    ...
    {
        return [
            self::SPECIFICATION_ELECTRICAL_ITEMS_FRIDGES_AND_FREEZERS,
            self::SPECIFICATION_ELECTRICAL_ITEMS_LARGE,
            self::SPECIFICATION_ELECTRICAL_ITEMS_IT,
            self::SPECIFICATION_ELECTRICAL_ITEMS_SMALL,
            self::SPECIFICATION_BATTERIES_ALKALINE,
            self::SPECIFICATION_BATTERIES_LI_ION,
            self::SPECIFICATION_BATTERIES_NIMH,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('activity', $data ?? [], 'electrical_items');
        $this->setIfExists('specification', $data ?? [], 'average');
        $this->setIfExists('detail', $data ?? [], 'primary_material_production');
