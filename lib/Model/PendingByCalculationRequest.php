...
/**
 * PendingByCalculationRequest Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class PendingByCalculationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'pendingByCalculation_request';
    ...
    */
    ...
    public function setOrderCount($orderCount)
    {
        ...
        if (($orderCount > 3)) {
            throw new \InvalidArgumentException('invalid value for $orderCount when calling PendingByCalculationRequest., must be smaller than or equal to 3.');
        }
        if (($orderCount < 1)) {
            throw new \InvalidArgumentException('invalid value for $orderCount when calling PendingByCalculationRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setFractionalDigits($fractionalDigits)
    {
        ...
        if (($fractionalDigits < 0)) {
            throw new \InvalidArgumentException('invalid value for $fractionalDigits when calling PendingByCalculationRequest., must be bigger than or equal to 0.');
        }
