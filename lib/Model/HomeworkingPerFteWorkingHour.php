...
/**
 * HomeworkingPerFteWorkingHour Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class HomeworkingPerFteWorkingHour implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HomeworkingPerFteWorkingHour';
    ...
    public const ACTIVITY_OFFICE_EQUIPMENT = 'office_equipment';
    public const ACTIVITY_HEATING = 'heating';
    public const ACTIVITY_HOMEWORKING_OFFICE_EQUIPMENT__HEATING = 'homeworking_office_equipment_+_heating';
    public const ACTIVITY_AVERAGE = 'average';
    public const UNIT_PER_FTE_WORKING_HOUR = 'per_fte_working_hour';
    ...
    {
        return [
            self::ACTIVITY_OFFICE_EQUIPMENT,
            self::ACTIVITY_HEATING,
            self::ACTIVITY_HOMEWORKING_OFFICE_EQUIPMENT__HEATING,
    ...
    {
        return [
            self::UNIT_PER_FTE_WORKING_HOUR,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('unit', $data ?? [], 'per_fte_working_hour');
    }
