...
/**
 * MaterialUseTextilesCurrency Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class MaterialUseTextilesCurrency implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MaterialUseTextilesCurrency';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('activity', $data ?? [], 'textiles');
