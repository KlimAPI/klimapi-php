...
/**
 * MetadataOrders Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class MetadataOrders implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MetadataOrders';
    ...
    */
     ...
     * Gets orders
     *
     * @return \KlimAPI\Model\Order[]|null
     */
     ...
     * Sets orders
     *
     * @param \KlimAPI\Model\Order[]|null $orders orders
     *
     * @return self
     */
