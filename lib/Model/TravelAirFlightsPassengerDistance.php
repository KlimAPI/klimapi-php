...
/**
 * TravelAirFlightsPassengerDistance Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class TravelAirFlightsPassengerDistance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TravelAirFlightsPassengerDistance';
    ...
    public const SPECIFICATION_SHORT_HAUL = 'short-haul';
    public const SPECIFICATION_LONG_HAUL = 'long-haul';
    public const SPECIFICATION_AVERAGE = 'average';
    public const DETAIL_ECONOMY_CLASS = 'economy_class';
    public const DETAIL_BUSINESS_CLASS = 'business_class';
    public const DETAIL_AVERAGE = 'average';
    public const DETAIL_PREMIUM_ECONOMY_CLASS = 'premium_economy_class';
    public const DETAIL_FIRST_CLASS = 'first_class';
    public const UNIT_KILOMETERS = 'passenger.kilometers';
    public const UNIT_METERS = 'passenger.meters';
    public const UNIT_MILES = 'passenger.miles';
    ...
    {
        return [
            self::SPECIFICATION_SHORT_HAUL,
            self::SPECIFICATION_LONG_HAUL,
    ...
    {
        return [
            self::DETAIL_ECONOMY_CLASS,
            self::DETAIL_BUSINESS_CLASS,
            self::DETAIL_AVERAGE,
            self::DETAIL_PREMIUM_ECONOMY_CLASS,
            self::DETAIL_FIRST_CLASS,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('activity', $data ?? [], 'flights');
        $this->setIfExists('specification', $data ?? [], 'average');
        $this->setIfExists('detail', $data ?? [], 'average');
        $this->setIfExists('value', $data ?? [], null);
        $this->setIfExists('unit', $data ?? [], 'passenger.kilometers');
    }
    ...
    */
     ...
     * Sets unit
     *
     * @param string|null $unit Distance a passenger traveled in the given unit.    **Example:** 2 passengers travel 300 kilometers. So the right `value` would be **600** and the `unit` would be **passenger.kilometers**.    Need a more specific unit? See the **[full list of supported units (Section 6)](https://convert.js.org/types/_unitsbymeasureraw)**.
     *
     * @return self
     */
