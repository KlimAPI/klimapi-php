...
/**
 * PendingByCarbonRequest Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class PendingByCarbonRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'pendingByCarbon_request';
    ...
    */
    ...
    public function setOrderCount($orderCount)
    {
        ...
        if (($orderCount > 3)) {
            throw new \InvalidArgumentException('invalid value for $orderCount when calling PendingByCarbonRequest., must be smaller than or equal to 3.');
        }
        if (($orderCount < 1)) {
            throw new \InvalidArgumentException('invalid value for $orderCount when calling PendingByCarbonRequest., must be bigger than or equal to 1.');
        }
