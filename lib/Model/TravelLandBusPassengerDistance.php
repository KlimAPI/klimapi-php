...
/**
 * TravelLandBusPassengerDistance Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class TravelLandBusPassengerDistance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TravelLandBusPassengerDistance';
    ...
    public const SPECIFICATION_LOCAL_BUS = 'local_bus';
    public const SPECIFICATION_AVERAGE_LOCAL_BUS = 'average_local_bus';
    public const SPECIFICATION_COACH = 'coach';
    ...
    {
        return [
            self::SPECIFICATION_LOCAL_BUS,
            self::SPECIFICATION_AVERAGE_LOCAL_BUS,
            self::SPECIFICATION_COACH,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('activity', $data ?? [], 'bus');
