...
/**
 * WasteDisposalRefuseWeight Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class WasteDisposalRefuseWeight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WasteDisposalRefuseWeight';
    ...
    public const SPECIFICATION_HOUSEHOLD_RESIDUAL_WASTE = 'household_residual_waste';
    public const SPECIFICATION_ORGANICFOOD_AND_DRINK_WASTE = 'organic:food_and_drink_waste';
    public const SPECIFICATION_ORGANICGARDEN_WASTE = 'organic:garden_waste';
    public const SPECIFICATION_ORGANICMIXED_FOOD_AND_GARDEN_WASTE = 'organic:mixed_food_and_garden_waste';
    public const SPECIFICATION_COMMERCIAL_AND_INDUSTRIAL_WASTE = 'commercial_and_industrial_waste';
    ...
    public const DETAIL_ANAEROBIC_DIGESTION = 'anaerobic_digestion';
    ...
    {
        return [
            self::SPECIFICATION_HOUSEHOLD_RESIDUAL_WASTE,
            self::SPECIFICATION_ORGANICFOOD_AND_DRINK_WASTE,
            self::SPECIFICATION_ORGANICGARDEN_WASTE,
            self::SPECIFICATION_ORGANICMIXED_FOOD_AND_GARDEN_WASTE,
            self::SPECIFICATION_COMMERCIAL_AND_INDUSTRIAL_WASTE,
    ...
    public function getDetailAllowableValues()
    {
        return [
            ...
            self::DETAIL_ANAEROBIC_DIGESTION,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('activity', $data ?? [], 'refuse');
