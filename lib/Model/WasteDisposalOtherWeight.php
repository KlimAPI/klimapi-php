...
/**
 * WasteDisposalOtherWeight Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class WasteDisposalOtherWeight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WasteDisposalOtherWeight';
    ...
    public const SPECIFICATION_BOOKS = 'books';
