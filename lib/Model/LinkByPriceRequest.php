...
/**
 * LinkByPriceRequest Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class LinkByPriceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'linkByPrice_request';
    ...
    */
     ...
     * Sets priceAmount
     *
     * @param float $priceAmount The total of the compensation in your given currency **incl. VAT**. Minimum order is 0.5 in your given currency.
     *
     * @return self
     */
    public function setPriceAmount($priceAmount)
    {
        ...
        if (($priceAmount < 0.5)) {
            throw new \InvalidArgumentException('invalid value for $priceAmount when calling LinkByPriceRequest., must be bigger than or equal to 0.5.');
        }
    ...
    public function setOrderCount($orderCount)
    {
        ...
        if (($orderCount > 3)) {
            throw new \InvalidArgumentException('invalid value for $orderCount when calling LinkByPriceRequest., must be smaller than or equal to 3.');
        }
        if (($orderCount < 1)) {
            throw new \InvalidArgumentException('invalid value for $orderCount when calling LinkByPriceRequest., must be bigger than or equal to 1.');
        }
