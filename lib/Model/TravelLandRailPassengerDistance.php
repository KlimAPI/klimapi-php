...
/**
 * TravelLandRailPassengerDistance Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class TravelLandRailPassengerDistance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'TravelLandRailPassengerDistance';
    ...
    public const SPECIFICATION_NATIONAL_RAIL = 'national_rail';
    public const SPECIFICATION_INTERNATIONAL_RAIL = 'international_rail';
    public const SPECIFICATION_LIGHT_RAIL_AND_TRAM = 'light_rail_and_tram';
    ...
    {
        return [
            self::SPECIFICATION_NATIONAL_RAIL,
            self::SPECIFICATION_INTERNATIONAL_RAIL,
            self::SPECIFICATION_LIGHT_RAIL_AND_TRAM,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('activity', $data ?? [], 'rail');
