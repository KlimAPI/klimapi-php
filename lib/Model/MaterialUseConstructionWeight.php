...
/**
 * MaterialUseConstructionWeight Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class MaterialUseConstructionWeight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MaterialUseConstructionWeight';
    ...
    public const SPECIFICATION_AGGREGATES = 'aggregates';
    public const SPECIFICATION_ASBESTOS = 'asbestos';
    public const SPECIFICATION_ASPHALT = 'asphalt';
    public const SPECIFICATION_BRICKS = 'bricks';
    public const SPECIFICATION_CONCRETE = 'concrete';
    public const SPECIFICATION_INSULATION = 'insulation';
    public const SPECIFICATION_METALS = 'metals';
    public const SPECIFICATION_SOILS = 'soils';
    public const SPECIFICATION_MINERAL_OIL = 'mineral_oil';
    public const SPECIFICATION_PLASTERBOARD = 'plasterboard';
    public const SPECIFICATION_TYRES = 'tyres';
    public const SPECIFICATION_WOOD = 'wood';
    public const SPECIFICATION_AVERAGE = 'average';
    public const DETAIL_PRIMARY_MATERIAL_PRODUCTION = 'primary_material_production';
    public const DETAIL_RE_USED = 're-used';
    ...
    {
        return [
            self::SPECIFICATION_AGGREGATES,
            self::SPECIFICATION_ASBESTOS,
            self::SPECIFICATION_ASPHALT,
            self::SPECIFICATION_BRICKS,
            self::SPECIFICATION_CONCRETE,
            self::SPECIFICATION_INSULATION,
            self::SPECIFICATION_METALS,
            self::SPECIFICATION_SOILS,
            self::SPECIFICATION_MINERAL_OIL,
            self::SPECIFICATION_PLASTERBOARD,
            self::SPECIFICATION_TYRES,
            self::SPECIFICATION_WOOD,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('activity', $data ?? [], 'construction');
