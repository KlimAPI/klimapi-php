...
/**
 * FreightingGoodsRailDepartureAndDestination Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class FreightingGoodsRailDepartureAndDestination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FreightingGoodsRailDepartureAndDestination';
    ...
    public const SPECIFICATION_FREIGHT_TRAIN = 'freight_train';
    ...
    {
        return [
            self::SPECIFICATION_FREIGHT_TRAIN,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('specification', $data ?? [], 'freight_train');
