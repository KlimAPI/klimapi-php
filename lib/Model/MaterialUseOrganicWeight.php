...
/**
 * MaterialUseOrganicWeight Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class MaterialUseOrganicWeight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MaterialUseOrganicWeight';
    ...
    public const SPECIFICATION_COMPOST_DERIVED_FROM_GARDEN_WASTE = 'compost_derived_from_garden_waste';
    public const SPECIFICATION_COMPOST_DERIVED_FROM_FOOD_AND_GARDEN_WASTE = 'compost_derived_from_food_and_garden_waste';
    ...
    {
        return [
            self::SPECIFICATION_COMPOST_DERIVED_FROM_GARDEN_WASTE,
            self::SPECIFICATION_COMPOST_DERIVED_FROM_FOOD_AND_GARDEN_WASTE,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('activity', $data ?? [], 'organic');
