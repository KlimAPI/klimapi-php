...
/**
 * FreightingGoodsFreightFlightsDepartureAndDestination Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class FreightingGoodsFreightFlightsDepartureAndDestination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FreightingGoodsFreightFlightsDepartureAndDestination';
    ...
    public const SPECIFICATION_DOMESTIC = 'domestic';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('activity', $data ?? [], 'freight_flights');
