...
class OrderCalculated implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'recipient' => '\KlimAPI\Model\OrderRecipient'
    ];
    ...
    */
     ...
     *
     * @param \DateTime|null $certificateIssuedAt Timestamp of when the certificate was issued in ISO 8601 format (UTC)
     *
     * @return self
     */
     ...
     * Sets certificateUrl
     *
     * @param string|null $certificateUrl certificateUrl
     *
     * @return self
     */
     ...
     * Sets certificatePdf
     *
     * @param string|null $certificatePdf certificatePdf
     *
     * @return self
     */
     ...
     * Gets recipient
     *
     * @return \KlimAPI\Model\OrderRecipient|null
     */
     ...
     * Sets recipient
     *
     * @param \KlimAPI\Model\OrderRecipient|null $recipient recipient
     *
     * @return self
     */
