...
/**
 * BioenergyBiogasEnergy Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class BioenergyBiogasEnergy implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BioenergyBiogasEnergy';
    ...
    public const SPECIFICATION_LANDFILL_GAS = 'landfill_gas';
    ...
    {
        return [
            self::SPECIFICATION_LANDFILL_GAS,
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('activity', $data ?? [], 'biogas');
