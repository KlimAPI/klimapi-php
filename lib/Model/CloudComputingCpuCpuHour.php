...
/**
 * CloudComputingCpuCpuHour Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class CloudComputingCpuCpuHour implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CloudComputingCpuCpuHour';
    ...
    public const UNIT_CPU_HOUR = 'cpu-hour';
