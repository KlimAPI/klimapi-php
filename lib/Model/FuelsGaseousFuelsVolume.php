...
/**
 * FuelsGaseousFuelsVolume Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class FuelsGaseousFuelsVolume implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FuelsGaseousFuelsVolume';
    ...
    public const SPECIFICATION_BUTANE = 'butane';
    public const SPECIFICATION_CNG = 'cng';
    public const SPECIFICATION_LNG = 'lng';
    public const SPECIFICATION_LPG = 'lpg';
    public const SPECIFICATION_OTHER_PETROLEUM_GAS = 'other_petroleum_gas';
    public const SPECIFICATION_PROPANE = 'propane';
    public const SPECIFICATION_AVERAGE = 'average';
    public const SPECIFICATION_NATURAL_GAS = 'natural_gas';
    public const SPECIFICATION_NATURAL_GAS_100_MINERAL_BLEND = 'natural_gas_100%_mineral_blend';
    public const SPECIFICATION_AVERAGE2 = 'average';
    ...
    {
        return [
            self::SPECIFICATION_BUTANE,
            self::SPECIFICATION_CNG,
            self::SPECIFICATION_LNG,
            self::SPECIFICATION_LPG,
            self::SPECIFICATION_OTHER_PETROLEUM_GAS,
            self::SPECIFICATION_PROPANE,
            self::SPECIFICATION_AVERAGE,
            self::SPECIFICATION_NATURAL_GAS,
            self::SPECIFICATION_NATURAL_GAS_100_MINERAL_BLEND,
            self::SPECIFICATION_AVERAGE2,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('activity', $data ?? [], 'gaseous_fuels');
