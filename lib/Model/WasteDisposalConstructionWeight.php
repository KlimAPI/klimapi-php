...
/**
 * WasteDisposalConstructionWeight Class Doc Comment
 *
 * @category Class
 * @package  KlimAPI
 * @author   KlimAPI Team
 ...
 */
class WasteDisposalConstructionWeight implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WasteDisposalConstructionWeight';
    ...
    public const DETAIL_COMPOSTING = 'composting';
