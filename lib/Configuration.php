...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.klimapi.com/v2';
     ...
     * @var string
     */
    protected $userAgent = 'KlimAPI/klimapi-php/2.0.14';
    ...
    {
        $report  = 'PHP SDK (KlimAPI) Debug Report:' . PHP_EOL;
